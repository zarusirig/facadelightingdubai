...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // NOTE: scroll progress, header scroll state, FAQ accordion, mobile nav,
  // dropdowns, and cursor glow are all handled by main.js — binding them here
  // too made each click toggle twice and cancel itself out.
